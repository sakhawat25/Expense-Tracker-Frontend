    ...
    <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-2">
            <div class="relative">
                ...
                <input ref="inputRef" :type="type" :id="inputId" v-model="model" :placeholder="placeholder" :class="['transition-all delay-50 duration-200 focus:outline-indigo-700 outline outline-2 outline-indigo-300 px-12 py-2 rounded-md text-indigo-700 w-full',
